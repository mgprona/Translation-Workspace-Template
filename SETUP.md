...
template นี้เป็นกลางเรื่องภาษา — **ต้นฉบับหลักจะเป็นภาษาอะไรก็ได้** (เกาหลี/อังกฤษ/จีน/ฯลฯ) ภาษาหลักจะถูกถาม+บันทึกตอน bootstrap (ขั้นตอน 4)

- วางไฟล์**ต้นฉบับหลัก** (ภาษาที่ยึดแปล) ที่ `sources/primary_chapter/`
  - ตั้งชื่อ `ch001.txt`, `ch002.txt`, ...
- ถ้ามี**source อ้างอิงรอง** (อีกภาษาหนึ่ง ไว้ตรวจชื่อ/นัย) วางที่ `sources/reference_chapter/` (ถ้ามี)
  - ตั้งชื่อ `ch001.txt`, `ch002.txt`, ...

> **เลือกภาษาหลักให้ตรงกับที่จะแปลจริง** — เช่นถ้าจะแปลจากเกาหลี วางไฟล์เกาหลีใน `primary_chapter/` (ไม่ใช่อังกฤษ)
> **ห้ามก็อปไฟล์ภาษาเดียวกันใส่ทั้งสองโฟลเดอร์** — ถ้ามี source ภาษาเดียว ให้ `reference_chapter/` ว่างไว้ (`verify-sources.ps1` จะเตือนถ้าสองโฟลเดอร์เหมือนกัน)
...
>
> ถ้าชื่อไม่ตรงและไม่แก้ AI จะหา source ไม่เจอทั้งโปรเจกต์ — ตรวจด้วยการลองเปิด `sources/primary_chapter/ch001.txt` ว่ามีจริง
