...
ถ้า OKF ยังว่างเปล่า ให้เตรียมฐานข้อมูลก่อน — เลือกตามสถานการณ์:

- **เริ่มเรื่องใหม่ ไม่เคยแปลมาก่อน** → ใช้ `prompts/08-bootstrap-okf.md` — อ่าน 5 ตอนแรก → สกัดตัวละคร ศัพท์ สำนัก สถานที่ วิชา → เติม OKF อัตโนมัติ
- **แปลต่อจากงานเก่าที่มี OKF/บทแปลเดิม** → ใช้ `prompts/09-import-okf.md` — ดึง OKF เดิมมาใช้เป็นมาตรฐาน เพื่อไม่ให้คำแปลแกว่งจากของเดิม
