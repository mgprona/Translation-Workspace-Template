...
- [ ] workspace audit — รัน `powershell -File etc/audit-workspace.ps1 -Start {CHAPTER_NUMBER} -End {CHAPTER_NUMBER} -CheckText` ก่อนสร้าง final และต้องไม่มี block issue
